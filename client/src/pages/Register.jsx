...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await register(username, password, profilePicture);
            if (result.success) {
                navigate('/home');
            } else {
                    ...
                    <div className="backdrop-blur-lg bg-white/20 dark:bg-gray-900/20 rounded-2xl shadow-xl border border-white/30 dark:border-gray-700/30 p-6 md:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold py-3 px-6 rounded-xl shadow-lg transform transition duration-300 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
                            >
                        ...
                        <p className="mt-6 text-center text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <Link to="/login" className="text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 font-semibold transition duration-300">
                                Login
                            </Link>
                        </p>
                    </div>
